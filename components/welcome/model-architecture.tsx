  ...
  return (
    <div className="py-16 px-4">
      ...
      >
        ...
        <p
          className={`text-muted-foreground max-w-2xl mx-auto transition-colors duration-300 ${
            ...
            <CardContent className="p-6">
              <div className="space-y-8">
                <div className="flex flex-col items-center">
                  ...
                  >
                    Text Analysis Neural Network Architecture
                  </h3>
                  <p
                    className={`text-muted-foreground text-center max-w-3xl mb-8 transition-colors duration-300 ${
                      isDark ? "text-gray-400" : "text-gray-600"
                    }`}
                  >
                ...
                <div className="relative">
                  <div
                    className={`absolute left-0 right-0 h-1 top-24 transition-colors duration-300 ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    {[
                      ...
                      <div key={i} className="relative flex flex-col items-center text-center">
                        <div
                          className={`z-10 w-16 h-16 rounded-full transition-colors duration-300 ${
                            isDark ? "bg-blue-900/30 border border-blue-800" : "bg-blue-100 border border-blue-300"
                        ...
                        <p
                          className={`text-xs text-muted-foreground mt-1 transition-colors duration-300 ${
                            isDark ? "text-gray-400" : "text-gray-600"
                          }`}
                        >
                          {step.description}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      From social media, forums, and messaging platforms
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4
            ...
            <CardContent className="p-6">
              <div className="space-y-8">
                <div className="flex flex-col items-center">
                  ...
                  >
                    Image Analysis CNN Architecture
                  </h3>
                  <p
                    className={`text-muted-foreground text-center max-w-3xl mb-8 transition-colors duration-300 ${
                      isDark ? "text-gray-400" : "text-gray-600"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  <div className="space-y-2">
                    ...
                    >
                      Modified ResNet with custom layers
                    </p>
                    <p
                      className={`text-xs text-muted-foreground transition-colors duration-300 ${
                        isDark ? "text-gray-500" : "text-gray-500"
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      Includes memes, screenshots, and modified images
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4
